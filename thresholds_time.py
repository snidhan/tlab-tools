...
for i in range(0,len(pvthresholds)):
    ...
    pv_turb_s1_mean_NS42[:,:,i] = pv_turb_s1mean - N**2*NS42.y
    ...
    pv_nonturb_s1_mean_NS42[:,:,i] = pv_nonturb_s1mean - N**2*NS42.y
    ...
    pv_turb_data = nc.Dataset(pv_turb_file,'r')
    pv_turb_s1mean = pv_turb_data.variables['Scalar1Mom1'][:,:]
    pv_turb_s1_mean_S20[:,:,i] = pv_turb_s1mean - N**2*S20.y
    ...
    pv_nonturb_data = nc.Dataset(pv_nonturb_file,'r')
    pv_nonturb_s1mean = pv_nonturb_data.variables['Scalar1Mom1'][:,:]
    pv_nonturb_s1_mean_S20[:,:,i] = pv_nonturb_s1mean - N**2*S20.y
...
ax2.set_xlim(np.log10(pvthresholds[0]/(cb*ceps*(np.mean(NS42.z_enc)/L0)**(-4./3.)*(B0/nu_42)**3/42)),np.log10(pvthresholds[-1]/(cb*ceps*(np.mean(S20.z_enc)/L0)**(-4./3.)*(B0/nu_42)**3/42)))
ax4.set_xlim(np.log10(pvthresholds[0]/(cb*ceps*(np.mean(NS42.z_enc)/L0)**(-4./3.)*(B0/nu_42)**3/42)),np.log10(pvthresholds[-1]/(cb*ceps*(np.mean(S20.z_enc)/L0)**(-4./3.)*(B0/nu_42)**3/42)))
...
cs2 = ax2.contourf(np.log10(pvthresholds/(cb*ceps*(np.mean(NS42.z_enc)/L0)**(-4./3.)*(B0/nu_42)**3/42)),NS42.y/np.mean(NS42.z_enc),pv_turb_area_fracs_NS42_timmean,cmap=imola_map,levels=np.arange(0,1.1,0.1))
...
cs4 = ax4.contourf(np.log10(pvthresholds/(cb*ceps*(np.mean(S20.z_enc)/L0)**(-4./3.)*(B0/nu_42)**3/42)),S20.y/np.mean(S20.z_enc),pv_turb_area_fracs_S20_timmean,cmap=imola_map,levels=np.arange(0,1.1,0.1))
...
ax3.axvline(-0.87,0,S20.y[-1]/np.mean(S20.z_enc),color='k',linestyle='--')
...
ax3.axvline(-0.87,0,S20.y[-1]/np.mean(S20.z_enc),color='k',linestyle='--')
ax4.axvline(-0.87,0,S20.y[-1]/np.mean(S20.z_enc),color='k',linestyle='--')
...
ax3.set_xticks([-8,-6,-4,-2,0,2])
ax4.set_xticks([-8,-6,-4,-2,0,2])
cs1 = ax1.contourf(np.log10(pvthresholds**2/(ceps*B0/nu_42)),NS42.y/np.mean(NS42.z_enc),np.sqrt(pv_nonturb_s1_var_NS42_timmean)/(N**2*L0),cmap=imola_map,levels=np.arange(0,2.1,0.1),extend='max')
cs2 = ax2.contourf(np.log10(pvthresholds**2/(ceps*B0/nu_42)),NS42.y/np.mean(NS42.z_enc),np.sqrt(pv_turb_s1_var_NS42_timmean)/(N**2*L0),cmap=imola_map,levels=np.arange(0,2.1,0.1),extend='max')
cs3 = ax3.contourf(np.log10(pvthresholds**2/(ceps*B0/nu_42)),S20.y/np.mean(S20.z_enc),np.sqrt(pv_nonturb_s1_var_S20_timmean)/(N**2*L0),cmap=imola_map,levels=np.arange(0,2.1,0.1),extend='max')
cs4 = ax4.contourf(np.log10(pvthresholds**2/(ceps*B0/nu_42)),S20.y/np.mean(S20.z_enc),np.sqrt(pv_turb_s1_var_S20_timmean)/(N**2*L0),cmap=imola_map,levels=np.arange(0,2.1,0.1))
cbar_ax = f.add_axes([0.15,0.1,0.8,0.03])
cbar = f.colorbar(cs1,cax=cbar_ax,orientation='horizontal')
ax1.set_ylabel(r'$z/z_\mathrm{enc}$')
ax3.set_ylabel(r'$z/z_\mathrm{enc}$')
...
ax1.set_yticks([1,1.1,1.2,1.3,1.4,1.5])
ax3.set_yticks([1,1.1,1.2,1.3,1.4,1.5])
cs1 = ax1.contourf(np.log10(vort_thresholds**2/(ceps*B0/nu_42)),NS42.y/np.mean(NS42.z_enc),np.mean(vort_nonturb_s1_flux_NS42-(vort_nonturb_s1_mean_NS42*vort_nonturb_w_mean_NS42),axis=0)/B0,cmap=vik_map,levels=np.arange(-0.4,0.45,0.05),extend='min')
cs2 = ax2.contourf(np.log10(vort_thresholds**2/(ceps*B0/nu_42)),NS42.y/np.mean(NS42.z_enc),np.mean(vort_turb_s1_flux_NS42-(vort_turb_s1_mean_NS42*vort_turb_w_mean_NS42),axis=0)/B0,cmap=vik_map,levels=np.arange(-0.4,0.45,0.05),extend='min')
cs3 = ax3.contourf(np.log10(vort_thresholds**2/(ceps*B0/nu_42)),S20.y/np.mean(S20.z_enc),np.mean(vort_nonturb_s1_flux_S20-(vort_nonturb_s1_mean_S20*vort_nonturb_w_mean_S20),axis=0)/B0,cmap=vik_map,levels=np.arange(-0.4,0.45,0.05),extend='min')
cs4 = ax4.contourf(np.log10(vort_thresholds**2/(ceps*B0/nu_42)),S20.y/np.mean(S20.z_enc),np.mean(vort_turb_s1_flux_S20-(vort_turb_s1_mean_S20*vort_turb_w_mean_S20),axis=0)/B0,cmap=vik_map,levels=np.arange(-0.4,0.45,0.05),extend='min')
cbar_ax = f.add_axes([0.15,0.1,0.8,0.03])
cbar = f.colorbar(cs1,cax=cbar_ax,orientation='horizontal')
ax1.set_ylabel(r'$z/z_\mathrm{enc}$')
ax3.set_ylabel(r'$z/z_\mathrm{enc}$')
