...
ax1.set_ylabel(r'$z/z_\mathrm{enc}$')
ax1.set_title('(a)',fontsize=20,loc='left')
ax2.set_xlabel(r'$\langle b^\prime w^\prime\rangle_\mathrm{T}/B_0$')
ax2.set_ylabel(r'$z/z_\mathrm{enc}$')
ax2.set_title(r'(b)',fontsize=20,loc='left')
ax3.set_xlabel(r'$z_\mathrm{enc}/L_0$')
ax3.set_ylabel(r'$-(\langle b^\prime w^\prime \rangle_\mathrm{T})_{z_{i,f}}/B_0$')
