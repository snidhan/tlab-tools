...
for i in range(0,NS117_vortpdf.ny):
    maxvort_117[i] = NS117_vortpdf.xy_timeavg[0,i,np.argmax(NS117_vortpdf.pdf_timeavg[i,:NS117_vortpdf.nb])]
...
for i in range(0,NS117_pvpdf.ny):
    maxpv_117[i] = NS117_pvpdf.xy_timeavg[0,i,np.argmax(NS117_pvpdf.pdf_timeavg[i,:NS117_pvpdf.nb])]
...
for i in range(0,NS42_vortpdf.ny):
    maxvort_42_avg[i] = NS42_vortpdf.xy_timeavg[0,i,np.argmax(NS42_vortpdf.pdf_timeavg[i,:NS42_vortpdf.nb])]
...
for i in range(0,NS42_pvpdf.ny):
    maxpv_42_avg[i] = NS42_pvpdf.xy_timeavg[0,i,np.argmax(NS42_pvpdf.pdf_timeavg[i,:NS42_pvpdf.nb])]
...
for i in range(0,NS25_vortpdf.ny):
    maxvort_25[i] = NS25_vortpdf.xy_timeavg[0,i,np.argmax(NS25_vortpdf.pdf_timeavg[i,:NS25_vortpdf.nb])]
...
for i in range(0,NS25_pvpdf.ny):
    maxpv_25[i] = NS25_pvpdf.xy_timeavg[0,i,np.argmax(NS25_pvpdf.pdf_timeavg[i,:NS25_pvpdf.nb])]
...
for i in range(0,S20_42_vortpdf.ny):
    maxvort_S20_42_avg[i] = S20_42_vortpdf.xy_timeavg[0,i,np.argmax(S20_42_vortpdf.pdf_timeavg[i,:S20_42_vortpdf.nb])]
...
for i in range(0,S20_42_pvpdf.ny):
    maxpv_S20_42_avg[i] = S20_42_pvpdf.xy_timeavg[0,i,np.argmax(S20_42_pvpdf.pdf_timeavg[i,:S20_42_pvpdf.nb])]
...
NS42_vortpdf.xy_timeavg[1,:,:] = NS42_vortpdf.xy_timeavg[1,:,:]/np.mean(NS42.z_enc)
NS42_pvpdf.xy_timeavg[1,:,:] = NS42_pvpdf.xy_timeavg[1,:,:]/np.mean(NS42.z_enc)
NS42_s1gradpdf.xy_timeavg[1,:,:] = NS42_s1gradpdf.xy_timeavg[1,:,:]/np.mean(NS42.z_enc)

NS42_vortpdf.xy[1,it,:,:] = NS42_vortpdf.xy[1,it,:,:]/NS42.z_enc[it]
NS42_pvpdf.xy[1,it,:,:] = NS42_pvpdf.xy[1,it,:,:]/NS42.z_enc[it]
NS42_s1gradpdf.xy[1,it,:,:] = NS42_s1gradpdf.xy[1,it,:,:]/NS42.z_enc[it]

NS25_vortpdf.xy[1,:,:] = NS25_vortpdf.xy[1,:,:]/NS25.z_enc
NS25_pvpdf.xy[1,:,:] = NS25_pvpdf.xy[1,:,:]/NS25.z_enc

S20_42_vortpdf.xy_timeavg[1,:,:] = S20_42_vortpdf.xy_timeavg[1,:,:]/np.mean(S20_42.z_enc)
S20_42_pvpdf.xy_timeavg[1,:,:] = S20_42_pvpdf.xy_timeavg[1,:,:]/np.mean(S20_42.z_enc)
S20_42_s1gradpdf.xy_timeavg[1,:,:] = S20_42_s1gradpdf.xy_timeavg[1,:,:]/np.mean(S20_42.z_enc)

S20_42_vortpdf.xy[1,it,:,:] = S20_42_vortpdf.xy[1,it,:,:]/S20_42.z_enc[it]
S20_42_pvpdf.xy[1,it,:,:] = S20_42_pvpdf.xy[1,it,:,:]/S20_42.z_enc[it]
S20_42_s1gradpdf.xy[1,it,:,:] = S20_42_s1gradpdf.xy[1,it,:,:]/S20_42.z_enc[it]
...
NS42_vortpdf.xy_timeavg[0,:,:] = np.log10(np.exp(NS42_vortpdf.xy_timeavg[0,:,:])/(ceps*B0/nu_42))
NS42_pvpdf.xy_timeavg[0,:,:] = np.log10(np.exp(NS42_pvpdf.xy_timeavg[0,:,:])/(cb*ceps*(np.mean(NS42.z_enc)/L0)**(-4./3.)*(B0/nu_42)**3/42))
NS42_s1gradpdf.xy_timeavg[0,:,:] = np.log10(np.exp(NS42_s1gradpdf.xy_timeavg[0,:,:])/(cb*N**4*42*(np.mean(NS42.z_enc)/L0)**(-4./3.)))

NS42_vortpdf.xy[0,it,:,:] = np.log10(np.exp(NS42_vortpdf.xy[0,it,:,:])/(ceps*B0/nu_42))
NS42_pvpdf.xy[0,it,:,:] = np.log10(np.exp(NS42_pvpdf.xy[0,it,:,:])/(cb*ceps*(NS42.z_enc[it]/L0)**(-4./3.)*(B0/nu_42)**3/42))
NS42_s1gradpdf.xy[0,it,:,:] = np.log10(np.exp(NS42_s1gradpdf.xy[0,it,:,:])/(cb*N**4*42*(NS42.z_enc[it]/L0)**(-4./3.)))
...
S20_42_vortpdf.xy_timeavg[0,:,:] = np.log10(np.exp(S20_42_vortpdf.xy_timeavg[0,:,:])/(ceps*B0/nu_42))
S20_42_pvpdf.xy_timeavg[0,:,:] = np.log10(np.exp(S20_42_pvpdf.xy_timeavg[0,:,:])/(cb*ceps*(np.mean(S20_42.z_enc)/L0)**(-4./3.)*(B0/nu_42)**3/42))
S20_42_s1gradpdf.xy_timeavg[0,:,:] = np.log10(np.exp(S20_42_s1gradpdf.xy_timeavg[0,:,:])/(cb*N**4*42*(np.mean(S20_42.z_enc)/L0)**(-4./3.)))

S20_42_vortpdf.xy[0,it,:,:] = np.log10(np.exp(S20_42_vortpdf.xy[0,it,:,:])/(ceps*B0/nu_42))
S20_42_pvpdf.xy[0,it,:,:] = np.log10(np.exp(S20_42_pvpdf.xy[0,it,:,:])/(cb*ceps*(S20_42.z_enc[it]/L0)**(-4./3.)*(B0/nu_42)**3/42))
S20_42_s1gradpdf.xy[0,it,:,:] = np.log10(np.exp(S20_42_s1gradpdf.xy[0,it,:,:])/(cb*N**4*42*(S20_42.z_enc[it]/L0)**(-4./3.)))
...
ax1.set_yticks([0,0.25,0.5,0.75,1,1.25,1.5])
ax2.set_xticks([-6,-4,-2,0,2])
cs1 = ax1.contourf(NS42_vortpdf.xy_timeavg[0,:,:],NS42_vortpdf.xy_timeavg[1,:,:],NS42_vortpdf.pdf_timeavg[:NS42_vortpdf.ny,:NS42_vortpdf.nb],cmap=imola_map)
...
cs2 = ax2.contourf(NS42_pvpdf.xy_timeavg[0,:,:],NS42_pvpdf.xy_timeavg[1,:,:],NS42_pvpdf.pdf_timeavg[:NS42_pvpdf.ny,:NS42_pvpdf.nb],cmap=imola_map,levels=np.linspace(0,0.24,9))
...
cs3 = ax3.contourf(S20_42_vortpdf.xy_timeavg[0,:,:],S20_42_vortpdf.xy_timeavg[1,:,:],S20_42_vortpdf.pdf_timeavg[:S20_42_vortpdf.ny,:S20_42_vortpdf.nb],cmap=imola_map,levels=np.linspace(0,0.4,9))
...
cs4 = ax4.contourf(S20_42_pvpdf.xy_timeavg[0,:,:],S20_42_pvpdf.xy_timeavg[1,:,:],S20_42_pvpdf.pdf_timeavg[:S20_42_pvpdf.ny,:S20_42_pvpdf.nb],cmap=imola_map,levels=np.linspace(0,0.24,9))
...
ax1.set_yticks([0,0.25,0.5,0.75,1,1.25,1.5])
ax2.set_xticks([-6,-4,-2,0,2])
cs1 = ax1.contourf(NS42_vortpdf.xy[0,it,:,:],NS42_vortpdf.xy[1,it,:,:],NS42_vortpdf.pdf[2,:NS42_vortpdf.ny,:NS42_vortpdf.nb],cmap=imola_map)
...
cs2 = ax2.contourf(NS42_pvpdf.xy[0,it,:,:],NS42_pvpdf.xy[1,it,:,:],NS42_pvpdf.pdf[2,:NS42_pvpdf.ny,:NS42_pvpdf.nb],cmap=imola_map,levels=np.linspace(0,0.24,9))
...
cs3 = ax3.contourf(S20_42_vortpdf.xy[0,it,:,:],S20_42_vortpdf.xy[1,it,:,:],S20_42_vortpdf.pdf[2,:S20_42_vortpdf.ny,:S20_42_vortpdf.nb],cmap=imola_map,levels=np.linspace(0,0.4,9))
...
cs4 = ax4.contourf(S20_42_pvpdf.xy[0,it,:,:],S20_42_pvpdf.xy[1,it,:,:],S20_42_pvpdf.pdf[2,:S20_42_pvpdf.ny,:S20_42_pvpdf.nb],cmap=imola_map,levels=np.linspace(0,0.24,9))
...
ax1.set_yticks([0,0.25,0.5,0.75,1,1.25,1.5])
ax2.set_xticks([-6,-4,-2,0,2])
cs1 = ax1.contourf(NS42_vortpdf.xy[0,it,:,:],NS42_vortpdf.xy[1,it,:,:],NS42_vortpdf.pdf[1,:NS42_vortpdf.ny,:NS42_vortpdf.nb],cmap=imola_map)
...
cs2 = ax2.contourf(NS42_pvpdf.xy[0,it,:,:],NS42_pvpdf.xy[1,it,:,:],NS42_pvpdf.pdf[1,:NS42_pvpdf.ny,:NS42_pvpdf.nb],cmap=imola_map,levels=np.linspace(0,0.24,9))
...
cs3 = ax3.contourf(S20_42_vortpdf.xy[0,it,:,:],S20_42_vortpdf.xy[1,it,:,:],S20_42_vortpdf.pdf[1,:S20_42_vortpdf.ny,:S20_42_vortpdf.nb],cmap=imola_map,levels=np.linspace(0,0.4,9))
...
cs4 = ax4.contourf(S20_42_pvpdf.xy[0,it,:,:],S20_42_pvpdf.xy[1,it,:,:],S20_42_pvpdf.pdf[1,:S20_42_pvpdf.ny,:S20_42_pvpdf.nb],cmap=imola_map,levels=np.linspace(0,0.24,9))
...
ax1.set_yticks([0,0.25,0.5,0.75,1,1.25,1.5])
ax2.set_xticks([-6,-4,-2,0,2])
cs1 = ax1.contourf(NS42_vortpdf.xy[0,it,:,:],NS42_vortpdf.xy[1,it,:,:],NS42_vortpdf.pdf[0,:NS42_vortpdf.ny,:NS42_vortpdf.nb],cmap=imola_map)
...
cs2 = ax2.contourf(NS42_pvpdf.xy[0,it,:,:],NS42_pvpdf.xy[1,it,:,:],NS42_pvpdf.pdf[0,:NS42_pvpdf.ny,:NS42_pvpdf.nb],cmap=imola_map,levels=np.linspace(0,0.24,9))
...
cs3 = ax3.contourf(S20_42_vortpdf.xy[0,it,:,:],S20_42_vortpdf.xy[1,it,:,:],S20_42_vortpdf.pdf[0,:S20_42_vortpdf.ny,:S20_42_vortpdf.nb],cmap=imola_map,levels=np.linspace(0,0.4,9))
...
cs4 = ax4.contourf(S20_42_pvpdf.xy[0,it,:,:],S20_42_pvpdf.xy[1,it,:,:],S20_42_pvpdf.pdf[0,:S20_42_pvpdf.ny,:S20_42_pvpdf.nb],cmap=imola_map,levels=np.linspace(0,0.24,9))
