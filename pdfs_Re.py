...
ax1.axhline(np.mean(NS117.z_is/NS117.z_enc),0,0.05,color='k',linewidth=2)
...
ax2.axhline(np.mean(NS117.z_is/NS117.z_enc),0,0.05,color='k',linewidth=2)
...
ax3.axhline(np.mean(NS25.z_is/NS25.z_enc),0,0.05,color='k',linewidth=2)
...
ax4.axhline(np.mean(NS25.z_is/NS25.z_enc),0,0.05,color='k',linewidth=2)
